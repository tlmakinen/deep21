...
def unet_baseline(dropout=0.0):
   ...
   upconv1a = keras.layers.Conv2DTranspose(512,3,activation=tf.nn.relu,padding="same",name="upconv1a")(conv4b)
...
def unet_3Layer3conv(dropout=0.0):
   '''
