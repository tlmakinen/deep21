...
plus_names = ['/mnt/home/tmakinen/ceph/deep21_results/fg_plus_' + str(i+1) + '/' for i in range(5)]
minus_names = ['/mnt/home/tmakinen/ceph/deep21_results/fg_minus_' + str(i+1) + '/' for i in range(5)]
