...
for j in [2]:
    ...
    data = np.concatenate([(np.load('/mnt/home/tmakinen/ceph/pca_ska/data_%d/pca3_sim%03d.npy'%(j+1, i+1))) for i in range(90)], axis=0)
    y = np.concatenate([(np.load('/mnt/home/tmakinen/ceph/pca_ska/data_%d/cosmo_sim%03d.npy'%(j+1, i+1))) for i in range(90)], axis=0)
